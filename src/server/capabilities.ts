export const capabilities = {
  resources: {
    get_components: {
      description:
        "List of available oneport/ui components that can be used in the project",
      uri: "resource:get_components",
      contentType: "text/plain",
    },
    get_install_script_for_component: {
      description:
        "Generate installation script for a specific oneport/ui component based on package manager",
      uriTemplate:
    ...
    get_installation_guide: {
      description:
        "Get the installation guide for oneport/ui based on build tool and package manager",
      uriTemplate:
  ...
  tools: {
    get_component: {
      description:
        "Get the source code for a specific oneport/uicomponent",
      inputSchema: {
        type: "object",
        properties: {
          componentName: {
            type: "string",
            description:
              'Name of the oneport/ui component (e.g., "accordion", "button")',
          },
        },
    ...
    get_component_demo: {
      description:
        "Get demo code illustrating how a oneport/uicomponent should be used",
      inputSchema: {
        type: "object",
        properties: {
          componentName: {
