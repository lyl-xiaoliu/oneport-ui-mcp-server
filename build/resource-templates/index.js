                ...
                switch (currentFramework) {
                    case "react":
                        ...
                        guides = {
                            ...
                            vite: {
                                description: "Installation guide for Vue with Vite (Tailwind CSS v4)",
                                steps: [
                                    "1. Create a new Vite project (if you don't have one):",
                                    `${packageManager}${packageManager === "npm" ? " create" : ""} vite@latest my-vue-app -- --template vue-ts`,
                                    "",
                                    "Navigate to your project directory:",
                                    "cd my-vue-app",
                                    "",
                                    "2. Install Tailwind CSS v4:",
                                    `${packageManager} ${packageManager === "npm" ? "install" : "add"} tailwindcss @tailwindcss/vite`,
                                    "",
                                    "3. Install @types/node for path resolution:",
                                    `${packageManager} ${packageManager === "npm" ? "install" : "add"} -D @types/node`,
                                    "",
