...
export const prompts = {
    "build-oneport-page": {
        ...
        description: "Generate a complete oneport/ui page using components and blocks",
        arguments: [
            {
                name: "pageType",
                description: "Type of page to build (login, sidebar,)",
                required: true,
            },
            {
                name: "features",
    ...
    "create-auth-flow": {
        ...
        description: "Generate authentication pages using oneport/ui login blocks",
        arguments: [
            {
                name: "authType",
    ...
    "optimize-oneport-component": {
        ...
        description: "Optimize or enhance existing oneport/ui components with best practices",
        arguments: [
            {
                name: "component",
...
export const promptHandlers = {
    "build-oneport-page": ({ pageType, features = "", layout = "sidebar", style = "modern", }) => {
...
Provide complete ${framework} authentication flow code with proper TypeScript types, validation, and error handling.`,
    ...
    "optimize-oneport-component": ({ component, optimization = "performance", useCase = "general", }) => {
        const framework = "react";
        return {
            messages: [
                {
...
Provide complete ${framework} data table implementation with proper TypeScript types, mock data, and usage examples.`,
    ...
    "explore-components": ({ componentName, analysisType = "all", }) => {
        const framework = "react";
        return {
            messages: [
                {
...
Provide a comprehensive analysis with code examples and practical insights.`,
    ...
    "explore-blocks": ({ category, blockName, }) => {
        const framework = "react";
        return {
            messages: [
                {
